<template>
  <Dialog :open="isOpen" @close="onClose" class="fixed inset-0 z-10 overflow-y-auto">
    ...
    <DialogOverlay class="fixed inset-0 bg-blue-900 opacity-30" />
      <div class="relative inline-block bg-white sm:rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl sm:my-8 w-screen h-screen sm:max-w-lg sm:w-full sm:p-6 space-y-4">
