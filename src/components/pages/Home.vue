<template>
  <div class="h-screen w-screen bg-white">
    <Header />
    <button @click="goTo({ name: 'Edit'})"  type="button" class="relative block w-full border-2 border-gray-300 border-dashed rounded-lg p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
import Summary from "../layout/Preview.vue";
import Header from "../layout/Header.vue";
import ResumeForm from "../customUi/ResumeForm.vue";
import goTo from '../../composables/helpers.js'
